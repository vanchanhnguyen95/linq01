...
namespace FilteringOperators
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var filteredResult1 = studentList.Where(s => s.Age > 12 && s.Age < 20);
            ...
            mixedList.Add(new Student() { StudentID = 1, StudentName = "Moin" });
            ...
            var studentResult = from su in mixedList.OfType<Student>()
                                select su;
            foreach (var s in studentResult)
            {
